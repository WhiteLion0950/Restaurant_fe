  ...
  return (
    <div className="navbar">
      ...
      >
        ...
        <Button className="buttonNav" onClick={()=>{props.history.push("/cart")}}>
...
const mapStateToProps = (state) => ({
  ...
  numberCart:
    state.basket && state.basket.length > 0
      ? state.basket.reduce((somma, corrente) => somma + corrente.qnt, 0)
      : 0,
});
export default connect(mapStateToProps, null)(withRouter(NavbarCustom));
